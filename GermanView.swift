...
class GermanView:UITableViewController {
    ...
    var storyboardSwitch:[String] = ["bg1","bg2","bg3"]
    
    override func viewDidLoad() {
        arrayOfCellData = [cellData(text: "Class 1",image: #imageLiteral(resourceName: "germany.png"),colour: UIColor.white), cellData(text: "Class 2",image: #imageLiteral(resourceName: "germany.png"),colour: UIColor.white), cellData(text: "Class 3" ,image: #imageLiteral(resourceName: "germany.png"), colour: UIColor.white)]
